...
<html lang="en">
  <head>
    ...
    <title>Espaço Fios - Clientes</title>
                ...
                <div class="col-xs-12 col-sm-12">
                    <div class="box">
                        <div class="box-header">
                            <a href="usuario-form.php" class="btn btn-dark">
                                ...
                                <tbody>
                                    <?php foreach ($lista as $linha): ?>
                                        <tr>
                                            ...
                                            <td><?php echo $linha['celular'] ?></a></td>
                                            <td><?php echo $linha['email'] ?></a></td>
                                            <td>              
                                            <a href="usuario-excluir.php?id=<?php echo $linha['id'] ?>"
