...
<html lang="en">
  <head>
    ...
    <title>Espaço Fios - Novo Produto</title>
                    ...
                    <div class="box">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="pessoais">
                                    <div class="post"><br>
                                        <form id="form1" name="form1" class="form-horizontal" action="produtos-gravar.php" method="post" onsubmit="return checkCheckBox(this)" enctype="multipart/form-data">
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    ...
                                                    <label for="inputImagem" class="col-md-2 control-label">Imagem:</label>
                                                        <div class="col-sm-7">
                                                            ...
                                                            <h6><i class="fa fa-file-image-o margin-r-5"></i>Imagem referente ao produto</h6>
                                                        </div>
                                                    </div>
