...
<html lang="en">
  <head>
    ...
    <title>Espaço Fios - Novo Cliente</title>
                        ...
                        <div class="nav-tabs-custom">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="pessoais">
                                    <div class="post"><br>
                                        <form id="form1" name="form1" class="form-horizontal" action="usuario-gravar.php" method="post" onsubmit="return checkCheckBox(this)" enctype="multipart/form-data">
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <input type="text" class="form-control" name="inputCelular" id="inputCelular" >
                                                        </div>
                                                    </div>
                                ...
                                <!-- Fim da div tab content -->Warning: Undefined array key "inputId" in C:\xampp\htdocs\tcc\dashboard\usuario-editar.php on line 3
